<?php
namespace CryTrExcom\CRYT-php-client;
/* Class to handle CRYT API request */

class CrytApi {

	const GENESIS_TIME = 1500278400;
	const GENESIS_BLOCKID = '5043988894991654125';
	...
	public function initialize(){ 
		$sNode=defined('NODE')?NODE:'http://127.0.0.1:11112';
    ...
    */ 
	function getResponse($attribute='') {
		...
		if(empty($sResp)) {
			...
			$this->oResponse->errorDescription='CRYT node Timeout';
